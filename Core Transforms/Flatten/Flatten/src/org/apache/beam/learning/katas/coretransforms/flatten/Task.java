...
public class Task {
  ...
  static PCollection<String> applyTransform(PCollection<String> words1, PCollection<String> words2) {
    PCollectionList<String> pCollectionList = PCollectionList.of(words1).and(words2);
    return pCollectionList.apply(Flatten.pCollections());
  }
}